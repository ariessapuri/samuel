...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var validateInput = function validateInput(inputValue) {
      // Menghapus karakter non-numeric dan non-decimal
      inputValue = inputValue.replace(/[^\d.]/g, ''); // Menghapus multiple dots dan memastikan hanya satu desimal point

      inputValue = inputValue.replace(/^(\d*\.?)|(\.\d*)$/g, '$1$2'); // Parsing nilai menjadi float

      inputValue = parseFloat(inputValue) || ''; // Mengatur nilai v-model agar selalu sesuai dengan input yang valid
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* TEXT */
    ...
    onInput: _cache[19] || (_cache[19] = function ($event) {
      return $setup.buying_fee = $setup.validateInput($setup.buying_fee);
    }),
    placeholder: "Fee"
  }, null, 544
  /* NEED_HYDRATION, NEED_PATCH */
