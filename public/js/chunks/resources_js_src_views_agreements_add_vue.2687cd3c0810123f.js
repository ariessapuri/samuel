          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                showSuggestions.value = false;
                suggestion.split(" - "), _readOnlyError("client_code"); // Memecah dengan pemisah koma dan spasi

                _context.prev = 3;
                _context.next = 6;
                return axios__WEBPACK_IMPORTED_MODULE_3__["default"].get("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "clients/getClientDetail/").concat(client_code), {
                  headers: {
