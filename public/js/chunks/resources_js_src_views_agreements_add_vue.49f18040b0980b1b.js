...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var onInput = function onInput() {
      showSuggestions.value = true; // Tampilkan daftar saat ada input
    };

    var onBlur = function onBlur() {
      // Tunda sedikit agar pemilihan saran tidak terhalangi
      setTimeout(function () {
        showSuggestions.value = false; // Sembunyikan daftar saat kehilangan fokus
      }, 100);
    };

    var selectSuggestion = function selectSuggestion(suggestion) {
      searchTerm.value = suggestion;
      showSuggestions.value = false; // Sembunyikan daftar saat saran dipilih
    };
