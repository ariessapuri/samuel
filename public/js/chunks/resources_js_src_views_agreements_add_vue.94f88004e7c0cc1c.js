            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return axios__WEBPACK_IMPORTED_MODULE_3__["default"].get("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "clients/getClientDetail/").concat(client_code.value), {
                  ...
                  client_detail.value += client_data.name + "<br>";
                  client_detail.value += client_data.email + "<br>";
                  client_detail.value += client_data.phone + "<br>"; //"address": "{\"city\": \"KABUPATEN BANTUL\", \"district\": \"GADINGHARJO\", \"postcode\": \"55763\", \"province\": \"DAERAH ISTIMEWA YOGYAKARTA\", \"subdistrict\": \"SANDEN\", \"street_address\": \"dsadsa\"}",

                  console.log(client_detail);
                  console.log(client_detail.value);
                  client_detail.value = client_data.value;
