...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var selectSuggestion = function selectSuggestion(suggestion) {
      ...
      showSuggestions.value = false;
      var selected_client = suggestion.split(" - ");
      selected_client[0], _readOnlyError("client_code");
      console.log(client_code);
      /*
          try {
              const response = await axios.get(`${config.baseAPIURL}clients/getClientDetail/${client_code}`, {
                  headers: {
