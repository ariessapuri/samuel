...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var validateInput = function validateInput(inputValue) {
      ...
      if (inputValue.value !== '') {
        var decimalIndex = inputValue.value.indexOf('.');

        if (decimalIndex !== -1) {
          inputValue.value = inputValue.value.substring(0, decimalIndex + 1) + inputValue.value.substring(decimalIndex + 1).replace(/\./g, '');
        }
      }
