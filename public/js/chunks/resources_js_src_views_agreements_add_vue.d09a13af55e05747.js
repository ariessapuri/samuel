...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var formattedInput = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)('');
    ...
    var formatInput = function formatInput(event) {
      ...
      if (!isNaN(rawNumber) || rawNumber === '') {
        ...
        formattedInput.value = formatNumber(rawNumber);
      }
    };

    (0,vue__WEBPACK_IMPORTED_MODULE_0__.watch)(originalInput, function (newVal) {
      formattedInput.value = formatNumber(newVal);
    });
    var commaFormatDirective = {
      mounted: function mounted(el) {
        ...
        el.addEventListener('input', function (event) {
          ...
          if (!isNaN(rawNumber) || rawNumber === '') {
            el.value = formatNumber(rawNumber);
          }
        });
      }
    };
    ...
    __expose({
      commaFormatDirective: commaFormatDirective
    });
