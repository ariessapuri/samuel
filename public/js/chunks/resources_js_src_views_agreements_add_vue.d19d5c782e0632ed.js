  ...
  setup: function setup(__props, _ref) {
    ...
    var validateInput = function validateInput(inputValue, model) {
      ...
      for (var i = 0; i < inputValue.length; i++) {
        ...
        if (_char >= '0' && _char <= '9' || _char === '.' && !decimalFound) {
          if (_char === '.') {
            decimalFound = true;
          }
      ...
      } // Parsing nilai menjadi float


      cleanedValue = parseFloat(cleanedValue) || ''; // Mengatur nilai v-model agar selalu sesuai dengan input yang valid

      model.value = cleanedValue.toString(); // Validasi tambahan: jika model bukan angka, maka reset model ke nilai kosong
