...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var validateInput = function validateInput(inputValue) {
      ...
      inputValue.value = inputValue.value.replace(/[^0-9.]/g, ''); // Menghapus multiple dots

      inputValue.value = inputValue.value.replace(/(\..*)\./g, '$1'); // Parsing nilai menjadi float

      inputValue.value = parseFloat(inputValue.value) || ''; // Mengatur nilai v-model agar selalu sesuai dengan input yang valid
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* TEXT */
    ...
    onInput: _cache[19] || (_cache[19] = function ($event) {
      return $setup.validateInput($setup.buying_fee);
    }),
    placeholder: "Fee"
  }, null, 544
  /* NEED_HYDRATION, NEED_PATCH */
    ...
    onInput: _cache[21] || (_cache[21] = function ($event) {
      return $setup.validateInput($setup.selling_fee);
    }),
    placeholder: "Fee"
  }, null, 544
  /* NEED_HYDRATION, NEED_PATCH */
    ...
    onInput: _cache[23] || (_cache[23] = function ($event) {
      return $setup.validateInput($setup.referral_fee_1);
    }),
    placeholder: "Fee"
  }, null, 544
  /* NEED_HYDRATION, NEED_PATCH */
    ...
    onInput: _cache[25] || (_cache[25] = function ($event) {
      return $setup.validateInput($setup.referral_fee_2);
    }),
    placeholder: "Fee"
  }, null, 544
  /* NEED_HYDRATION, NEED_PATCH */
