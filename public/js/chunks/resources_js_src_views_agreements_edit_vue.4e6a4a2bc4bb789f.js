...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var checkSinglePermission = function checkSinglePermission(permissionName) {
      return axios__WEBPACK_IMPORTED_MODULE_5__["default"].get("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "access/checkSinglePermission/").concat(permissionName), {
        headers: {
          Authorization: "Bearer ".concat(token)
        }
      }).then(function (response) {
                        ...
                        while (1) {
                          switch (_context5.prev = _context5.next) {
                            case 0:
                              _context5.prev = 0;
                              _context5.next = 3;
                              return axios__WEBPACK_IMPORTED_MODULE_5__["default"].post("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "agreement/remove_attachment/").concat(id.value), {
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                loading.value = true;
                _context8.next = 27;
                return axios__WEBPACK_IMPORTED_MODULE_5__["default"].put("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "agreement/update/").concat(id.value), formData, {
                  headers: {
                    'Authorization': "Bearer ".concat(token),
