...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.onMounted)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
      var response, _response, attorneyData, agreementId, _response2, agreement_response, client_response;
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
                        ...
                        while (1) {
                          switch (_context5.prev = _context5.next) {
                            ...
                            case 3:
                              ...
                              if (_response3.data.success) {//console.log('File removed successfully from server.');
                              } else {
                                console.error('Failed to remove file from server:', _response3.data.message);
                      ...
                      switch (_context6.prev = _context6.next) {
                        ...
                        case 4:
                          ...
                          if (_response4.data.success) {
                            ...
                            console.error('Failed to remove image:', _response4.data.message);
                          }
            ...
            case 69:
              _context7.prev = 69;
              _context7.t3 = _context7["catch"](64);
      ...
      }, _callee7, null, [[0, 18], [4, 13], [21, 61], [64, 69]]);
    })));
