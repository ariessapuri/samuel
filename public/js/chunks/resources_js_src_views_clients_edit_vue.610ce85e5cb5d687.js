  ...
  setup: function setup(__props, _ref) {
    ...
    var submitForm = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var formData, response, FileformData, response2, newPath, alertElement, _newPath, _alertElement;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 23:
                ...
                _context.next = 29;
                return axios__WEBPACK_IMPORTED_MODULE_12__["default"].post("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "clients/attachments"), FileformData, {
                  headers: {
                    Authorization: "Bearer ".concat(token),
            ...
            case 14:
              ...
              myDropzone = new dropzone__WEBPACK_IMPORTED_MODULE_4__["default"](dropzoneRef.value, {
                ...
                init: function init() {
                  ...
                  this.on('removedfile', function (file) {
                    ...
                    var dataURLWithoutBase64 = dataURL.substring(dataURL.indexOf(',') + 1);
                    console.log(dataURLWithoutBase64);
              ...
              attachments.value.forEach(function (filePath) {
                ...
                removeLink.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
                  var _response2, index, updatedAttachments;
                    ...
                    while (1) {
                      switch (_context6.prev = _context6.next) {
                        case 0:
                          ...
                          _context6.next = 4;
                          return axios__WEBPACK_IMPORTED_MODULE_12__["default"].post("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "clients/remove_attachment"), {
                            url: file.url
                          }, {
                            headers: {
                              Authorization: "Bearer ".concat(token)
                        ...
                        case 4:
                          ...
                          updatedAttachments = myDropzone.files.map(function (f) {
                            return f.url;
                          });
                          _context6.next = 11;
                          return axios__WEBPACK_IMPORTED_MODULE_12__["default"].post('/api/update_attachments', {
