        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return axios__WEBPACK_IMPORTED_MODULE_4__["default"].get("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseURL, "zone/province"));

            case 4:
              test = _context.sent;
              console.log(test);
              _context.next = 8;
              return axios__WEBPACK_IMPORTED_MODULE_4__["default"].get("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseURL, "users/show/").concat(userId), {
                headers: {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _context2.next = 8;
                return axios__WEBPACK_IMPORTED_MODULE_4__["default"].post("http://localhost:8000/api/users/".concat(userId), formData, {
                  headers: {
