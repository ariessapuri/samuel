          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                loading.value = true;
                _context6.next = 23;
                return axios__WEBPACK_IMPORTED_MODULE_11__["default"].post("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "clients/update/").concat(id.value), formData, {
                  headers: {
              ...
              case 28:
                ...
                if (response1.data.message) {
                  successMessage.value = response1.data.message;
                  failedMessage.value = '';
                }
