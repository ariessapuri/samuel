          ...
          switch (_context5.prev = _context5.next) {
            ...
            case 14:
              ...
              attachments.value.forEach(function (filePath) {
                // Memeriksa apakah filePath tidak terdefinisi atau null
                if (filePath) {
                  // Lakukan sesuatu dengan filePath, misalnya fetch atau membaca file
                  // Misalnya, Anda dapat menggunakan fetch untuk mengambil konten file
                  fetch(filePath).then(function (response) {
                    ...
                    console.log(data); // Data dari file yang diambil
