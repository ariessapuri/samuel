          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 29:
                ...
                if (response.data.message) {
                  ...
                  if ($route.query.successMessage) {
                    ...
                    alertElement = document.querySelector('.alert.alert-light-primary');
              ...
              case 34:
                ...
                if ($route.query.successMessage) {
                  $route.query.successMessage = ''; // Hapus parameter successMessage dari URL

                  _alertElement = document.querySelector('.alert.alert-light-primary');

                  if (_alertElement) {
                    _alertElement.remove(); // Hapus elemen alert dari DOM
