            ...
            case 14:
              ...
              myDropzone = new dropzone__WEBPACK_IMPORTED_MODULE_4__["default"](dropzoneRef.value, {
                ...
                init: function init() {
                  ...
                  this.on('success', function (file, response) {
                    console.log(response); // Response dari server, termasuk nama file baru jika diberikan
                    // Logic to rename file after successful upload

                    var newFileName = response.newFileName; // Ambil nama file baru dari respons

                    if (newFileName) {
                      // Ubah nama file yang diunggah dengan nama baru
                        ...
                        while (1) {
                          switch (_context6.prev = _context6.next) {
                            ...
                            case 3:
                              ...
                              } // Menghapus file dari uploadedFiles
              ...
              attachments.value.forEach(function (filePath) {
                ...
                removeLink.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
                  var _response3, index, updatedAttachments;
