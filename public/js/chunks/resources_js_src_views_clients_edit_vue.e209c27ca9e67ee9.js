          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 23:
                ...
                _context.next = 28;
                return axios__WEBPACK_IMPORTED_MODULE_12__["default"].post("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "clients/attachments/").concat(id.value), FileformData, {
                  headers: {
                    Authorization: "Bearer ".concat(token),
