              ...
              myDropzone = new dropzone__WEBPACK_IMPORTED_MODULE_4__["default"](dropzoneRef.value, {
                ...
                init: function init() {
                  ...
                  this.on('success', function (file, response) {
                    ...
                    /*const newFileNames = response.files;
                    if (newFileNames && newFileNames.length > 0) {
                        const index = Array.from(this.files).findIndex(f => f.name === file.name);
                        if (index !== -1) {
                            const newFile = new File([file], newFileNames[index], { type: file.type });
                            this.files[index] = newFile;
                            console.log("File renamed to:", newFileNames[index]);
                        }
                    }*/
                  });
