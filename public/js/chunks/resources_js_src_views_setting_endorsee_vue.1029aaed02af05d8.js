...
function render(_ctx, _cache) {
  var _component_VueFilePond = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("VueFilePond");

  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_VueFilePond, {
    files: _ctx.files,
    "onUpdate:files": _cache[0] || (_cache[0] = function ($event) {
      return _ctx.files = $event;
    }),
    onInputFile: _ctx.handleInputFile,
    server: {
      url: '/upload',
      process: '/process',
      revert: '/revert'
