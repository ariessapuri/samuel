...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.onMounted)(function () {
      var fileUpload = new file_upload_with_preview__WEBPACK_IMPORTED_MODULE_3__["default"]('endorsee_upload_file', {
        images: {
          baseImage: __webpack_require__(/*! @/assets/images/file-preview.png */ "./resources/js/src/assets/images/file-preview.png"),
          backgroundImage: ''
        }
      }); // Dapatkan daftar gambar yang diunggah dari file-upload-with-preview

      fileUpload.on('image-preview-updated', function (preview) {
        attachments.value = preview.images;
      });
    });

    var openLightbox = function openLightbox(index) {
      // Implementasi logika untuk menampilkan lightbox sesuai dengan gambar yang diklik
      var imageUrl = attachments.value[index].file;
      console.log('Menampilkan lightbox untuk gambar:', imageUrl); // Anda dapat menggunakan library lightbox seperti baguetteBox atau yang lainnya di sini
    };
  ...
  /* NEED_PATCH */
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("img", {
      ...
      onClick: function onClick($event) {
        return $setup.openLightbox(index);
      }
    }, null, 8
    /* PROPS */
    , _hoisted_84);
