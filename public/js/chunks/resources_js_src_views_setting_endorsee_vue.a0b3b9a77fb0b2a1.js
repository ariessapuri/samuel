          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                loading.value = true;
                _context.next = 14;
                return axios__WEBPACK_IMPORTED_MODULE_8__["default"].post("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "endorsee/update"), formData, {
                  headers: {
