...
/* harmony import */ var _assets_sass_scrollspyNav_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/assets/sass/scrollspyNav.scss */ "./resources/js/src/assets/sass/scrollspyNav.scss");
/* harmony import */ var _assets_sass_forms_file_upload_with_preview_min_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/assets/sass/forms/file-upload-with-preview.min.css */ "./resources/js/src/assets/sass/forms/file-upload-with-preview.min.css");
/* harmony import */ var file_upload_with_preview__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! file-upload-with-preview */ "./node_modules/file-upload-with-preview/dist/file-upload-with-preview.esm.js");
...
/* harmony import */ var _composables_use_meta__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/composables/use-meta */ "./resources/js/src/composables/use-meta.js");
/* harmony import */ var _config_config_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/config/config.js */ "./resources/js/src/config/config.js");
...
var maxFiles = 5;
var allowFileSizeValidation = true;
var maxFileSize = '5MB'; // Fungsi yang akan di-ekspor
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    (0,filepond__WEBPACK_IMPORTED_MODULE_1__.registerPlugin)((filepond_plugin_file_validate_size__WEBPACK_IMPORTED_MODULE_2___default())); // Definisi properti
    ...
    var handleFileUpload = function handleFileUpload(files) {
      console.log('Files uploaded:', files); // Lakukan sesuatu dengan berkas yang diunggah di sini
    }; // Ekspor variabel dan fungsi yang diperlukan
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_7__["default"].baseURL, "zone/city/").concat(selectedProvince.value), {
                  headers: {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_7__["default"].baseURL, "zone/district/").concat(selectedCity.value), {
                  headers: {
                    Authorization: "Bearer ".concat(token)
                  }
                });
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_7__["default"].baseURL, "zone/subdistrict/").concat(selectedDistrict.value), {
                  headers: {
                    Authorization: "Bearer ".concat(token)
                  }
                });
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_7__["default"].baseURL, "zone/province"), {
                headers: {
                  Authorization: "Bearer ".concat(token)
                }
              });
            ...
            case 10:
              _context4.prev = 10;
              _context4.next = 13;
              return axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_7__["default"].baseURL, "endorsee"), {
                headers: {
                  Authorization: "Bearer ".concat(token)
                }
              });
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.onMounted)(function () {
      new file_upload_with_preview__WEBPACK_IMPORTED_MODULE_5__["default"]('endorsee_upload_file', {
        images: {
    ...
    var __returned__ = {
      ...
      get FilePond() {
        return filepond__WEBPACK_IMPORTED_MODULE_1__.FilePond;
      },

      get registerPlugin() {
        return filepond__WEBPACK_IMPORTED_MODULE_1__.registerPlugin;
      },

      get FilePondPluginFileValidateSize() {
        return (filepond_plugin_file_validate_size__WEBPACK_IMPORTED_MODULE_2___default());
      },

      get FileUploadWithPreview() {
        return file_upload_with_preview__WEBPACK_IMPORTED_MODULE_5__["default"];
      },
      ...
      get useMeta() {
        return _composables_use_meta__WEBPACK_IMPORTED_MODULE_6__.useMeta;
      },

      get config() {
        return _config_config_js__WEBPACK_IMPORTED_MODULE_7__["default"];
      }
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* KEYED_FRAGMENT */
  ))])])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["FilePond"], {
    ref: "pond",
    "allow-multiple": $setup.allowMultiple,
    "max-files": $setup.maxFiles,
    server: {
      process: $setup.handleFileUpload
    },
    onInit: $setup.handleInit,
    "allow-file-validate-size": $setup.allowFileSizeValidation,
    "max-file-size": $setup.maxFileSize
  }, null, 8
  /* PROPS */
  , ["server"])]), _hoisted_85], 32
  /* NEED_HYDRATION */
  )])])])])])])]);
}
