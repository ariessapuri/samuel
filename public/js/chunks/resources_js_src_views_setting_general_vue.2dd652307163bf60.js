...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.onMounted)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
      var response, _response, settingData, addressObject, file, imgElement, imageLink, removeLink, dzImageDiv, dzPreviewDiv;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 13:
              ...
              data_address.value = addressObject.street_address; //attachments.value.forEach(filePath => {

              file = {
                name: attachments.value.split('/').pop(),
                size: 0,
                url: "".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "storage/uploads/").concat(attachments.value.split('/').pop())
              };
