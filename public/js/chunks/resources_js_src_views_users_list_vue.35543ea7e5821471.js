  ...
  setup: function setup(__props, _ref) {
    ...
    var delete_row = function delete_row(item) {
      if (confirm('Are you sure want to delete selected row ?')) {
        axios__WEBPACK_IMPORTED_MODULE_4__["default"]["delete"]("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "users/delete/").concat(item.id), {
          headers: {
            Authorization: "Bearer ".concat(token)
          }
