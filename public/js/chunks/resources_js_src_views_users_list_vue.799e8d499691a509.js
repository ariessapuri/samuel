  ...
  setup: function setup(__props, _ref) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_4__["default"].get("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "users"), {
                  headers: {
    ...
    var delete_row = function delete_row(item) {
      if (confirm('Are you sure want to delete selected row ?')) {
        axios__WEBPACK_IMPORTED_MODULE_4__["default"]["delete"]("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "users/delete/").concat(item.id)).then(function (response) {
