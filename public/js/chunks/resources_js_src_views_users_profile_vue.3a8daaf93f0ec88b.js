        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_3__["default"].get("".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].baseAPIURL, "users/profile/show"), {
                headers: {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                loading.value = true;
                _context2.next = 5;
                return axios__WEBPACK_IMPORTED_MODULE_3__["default"].put("http://localhost:8000/api/users/profile/update", formData, {
                  headers: {
                    'Authorization': "Bearer ".concat(token)
                  }
                });
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.username]]), _hoisted_22]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_23, [_hoisted_24, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    type: "text",
    "class": "form-control",
