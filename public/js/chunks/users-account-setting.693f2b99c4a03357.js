        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return axios__WEBPACK_IMPORTED_MODULE_3__["default"].post("http://localhost:8000/users/show/".concat(userId));

            case 4:
              response = _context.sent;
              userData = response.data; // Detail pengguna dari respons
              // Mengisi nilai input atau select dengan detail pengguna
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _context2.next = 9;
                return axios__WEBPACK_IMPORTED_MODULE_3__["default"].post("http://localhost:8000/users/update/".concat(userId), formData, {
                  headers: {
                    'Authorization': "Bearer ".concat(token) // Add token to the Authorization header
