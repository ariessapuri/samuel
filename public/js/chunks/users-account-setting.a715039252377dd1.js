...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2__["default"].defaults.headers.common.Accept = 'application/json';
    var errorMessage = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)('');
    var name = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)('');
    var email = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)('');
    var username = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)('');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("http://localhost:8000/api/users/show/".concat(userId), {
                headers: {
                  Authorization: "Bearer ".concat(token) // Sertakan token akses dalam header Authorization

                }
              }).then(function (response) {
                console.log(response.data); // Tampilkan data pengguna yang diperoleh
              })["catch"](function (error) {
                console.error(error); // Tampilkan pesan kesalahan jika ada
              });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _context2.next = 8;
                return axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("http://localhost:8000/api/users/update/".concat(userId), formData, {
                  headers: {
                    'Authorization': "Bearer ".concat(token) // Add token to the Authorization header
