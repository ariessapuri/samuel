...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.email]])])]), _hoisted_17], 32
  /* NEED_HYDRATION */
  )])])])])])])]);
}
