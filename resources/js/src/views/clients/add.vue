                        ...
                        <div class="statbox panel box box-shadow">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <span class="badge-title badge badge-dark badge-classic">add client</span>
                                </div>
                            </div>
                            <div class="panel-body">
                                <form @submit.prevent="handleSubmit">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <input type="text" class="form-control" id="inputClientCode"
                                                v-model="client_code" placeholder="Code" required="required" />
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <select class="form-control" id="inputProvince" v-model="selectedProvince"
                                                @change="fetchCities" required="required">
                                        ...
                                        <div class="form-group col-md-6">
                                            <select class="form-control" id="inputCity" :disabled="!selectedProvince"
                                                v-model="selectedCity" @change="fetchDistricts" required="required">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <select class="form-control" id="inputDistrict" :disabled="!selectedCity"
                                                v-model="selectedDistrict" @change="fetchSubdistricts"
                                                required="required">
                                        ...
                                        <div class="form-group col-md-4">
                                            <select class="form-control" id="inputSubdistrict"
                                                ...
                                                <option :value="key" v-for="(value, key) in subdistricts" :key="key">{{
                                                    value }}</option>
                                            </select>
...
async function handleSubmit() {
    ...
    try {
        loading.value = true;
        const response = await axios.post(`${config.baseAPIURL}clients/store`, formData, {
            headers: {
        ...
        router.push({ name: 'clientsEdit', params: { Id: response.data.id }, query: { successMessage: 'Client created successfully' } });
...
onMounted(async () => {
    isPemissionOK.value = await checkSinglePermission('addClient');
    try {
